class Chassis extends Object3D {
  ...
  initialize3dComponents(n_rows, n_columns, shader, textures, gl) {
    ...
    this.front = new Parallelepiped(n_rows, n_columns, shader, null, gl)
    ...
    this.seat = new Parallelepiped(n_rows, n_columns, shader, null, gl)
    ...
    this.lift = new Lift(n_rows, n_columns, shader, null, gl)
  }
}