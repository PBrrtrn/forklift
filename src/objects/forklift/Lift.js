...
export default class Lift extends Object3D {
  ...
  initialize3dComponents(n_rows, n_columns, shader, textures, gl) {
    this.vertical_beam_1 = new Cuboid(12, 12, shader, textures.vertical_beam, gl)
    ...
    this.vertical_beam_2 = new Cuboid(12, 12, shader, textures.vertical_beam, gl)
    ...
    this.horizontal_beam_1 = new Cuboid(12, 12, shader, textures.horizontal_beam, gl)
    ...
    this.horizontal_beam_2 = new Cuboid(12, 12, shader, textures.horizontal_beam, gl)
    ...
    this.horizontal_beam_3 = new Cuboid(12, 12, shader, textures.horizontal_beam, gl)
    ...
    this.platform = new Cuboid(12, 12, shader, textures.platform, gl)
